...
import { MessageEffects } from './state/message/message.effect';
...
@NgModule({
  ...
  imports: [
   ...
   ScrollingModule,
    ...
    MatTooltipModule,
    MatSelectModule,
    StoreModule.forRoot({userReducer,channelReducer, messageReducer}, {}),
    EffectsModule.forRoot([UserEffect, ChannelEffect, MessageEffects]),
